...
{
    public class DeleteCoinsHandler : IRequestHandler<DeleteCoinsCommand, ReturnType<bool>>
    {
        ...
        public async Task<ReturnType<bool>> Handle(DeleteCoinsCommand request, CancellationToken cancellationToken)
        {
